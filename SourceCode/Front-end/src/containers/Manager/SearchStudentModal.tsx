...
function SearchStudentModal(props: Props) {
    ...
    const getStudentData = () => {
        ...
        typingTimeoutRef.current = setTimeout(() => {
            StudentService.getStudentNotInCourse(props.courseId, searchKeyword)
                .then((data) => {
                    console.log(data)
                    setListStudent(
        ...
        >
            ...
            <div className="min-h-[430px] max-h-[430px] flex">
                <div className="flex-1 h-full bg-white">
                    ...
                    <div className="h-full hideScroll p-1 overflow-y-auto">{renderUser()}</div>
                </div>

                <div className="flex-1 ml-1 h-full">
                    <h1>Sinh viên khoá học</h1>
