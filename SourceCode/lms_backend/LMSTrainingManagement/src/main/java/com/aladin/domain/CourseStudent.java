...
public class CourseStudent implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "department","lecturer","lessons","filesOfCourses","departments","courseStudents","student" }, allowSetters = true)
    private Course course;

    @ManyToOne
    @JsonIgnoreProperties(value = { "student", "courseStudents"  }, allowSetters = true)
