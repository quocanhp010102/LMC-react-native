...
@RestController
@RequestMapping("/api/lms-training-management-kafka")
public class LmsTrainingManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LmsTrainingManagementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LmsTrainingManagementKafkaResource(KafkaProperties kafkaProperties) {
