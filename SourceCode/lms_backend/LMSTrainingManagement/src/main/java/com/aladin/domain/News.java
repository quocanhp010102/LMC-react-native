...
public class News implements Serializable {
    ...
    private String news_isDisplay="0";

    @CreatedDate
    @Column(name = "news_created_date")
    private Date news_created_date = new Date();
...
//    }
    ...
    public News(Long id, String news_isDisplay, Date news_created_date, String news_title, String news_description, String news_content, String news_image) {
        this.id = id;
        this.news_isDisplay = news_isDisplay;
        this.news_created_date = news_created_date;
        this.news_title = news_title;
