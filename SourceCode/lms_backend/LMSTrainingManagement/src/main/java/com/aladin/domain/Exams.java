...
public class Exams implements Serializable {
    ...
    @Column(name = "exam_total_is_not_graded")
    private Long examTotalIsNotGraded =0L;

//    @Column(name = "exam_max_point")
//    private String examMaxPoint;
//
//    @Column(name = "exam_min_point")
//    private String examMinPoint;

    @OneToMany(mappedBy = "exams",fetch = FetchType.LAZY)
//    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
...
//    private Set<ExamsHistory> answers = new HashSet<>();
    ...
    public Long getExamTotalIsNotGraded() {
        return examTotalIsNotGraded;
    }

    public void setExamTotalIsNotGraded(Long examTotalIsNotGraded) {
        this.examTotalIsNotGraded = examTotalIsNotGraded;
    }
    ...
    public String toString() {
        return "Exams{" +
            ...
            ", examTotalIsNoteGraded="+examTotalIsNotGraded + '\'' +
            '}';
    }
}
