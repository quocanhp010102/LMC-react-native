...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, com.aladin.domain.Notification.class.getName(), jcacheConfiguration);
            createCache(cm, com.aladin.domain.NotiReceiver.class.getName(), jcacheConfiguration);
...
//            createCache(cm, "findAllNews", jcacheConfiguration);
//            createCache(cm, "findOneNews", jcacheConfiguration);
//            createCache(cm, "findLimitNewsByIsDisplay", jcacheConfiguration);
//            createCache(cm, "getAllNewsSortByCreatedDateAndIsDisplay", jcacheConfiguration);
//
//            createCache(cm, "findAllTutorials", jcacheConfiguration);
//            createCache(cm, "findAllTutorialsByAuthoritiesAndLimit", jcacheConfiguration);
//            createCache(cm, "findTutorialsByLimit", jcacheConfiguration);
//            createCache(cm, "findAllTutorialsByLstAuthen", jcacheConfiguration);
//            createCache(cm, "findOneTutorials", jcacheConfiguration);
//
//            createCache(cm, "findAllExamsHistory", jcacheConfiguration);
//            createCache(cm, "findOneExamsHistory", jcacheConfiguration);
//            createCache(cm, "findAllByCourseIdAndStudentId", jcacheConfiguration);
//            createCache(cm, "findOneExamsHistoryByExamsIdAndStudentId", jcacheConfiguration);
//
//            createCache(cm, "findAllExamsByCourseId", jcacheConfiguration);
//            createCache(cm, "findOneExamsById", jcacheConfiguration);
//
//            createCache(cm, "findOneNotes", jcacheConfiguration);
//            createCache(cm, "getAllNotesByUserAndMonth", jcacheConfiguration);
//            createCache(cm, "getAllNotesByCurrentuserLogin", jcacheConfiguration);
//
//            createCache(cm, "getAllNotificationBySenderId", jcacheConfiguration);
//            createCache(cm, "getAllNotificationByReceiverId", jcacheConfiguration);
//            createCache(cm, "getAllNotificationByUserLogin", jcacheConfiguration);
//            createCache(cm, "findOneNotification", jcacheConfiguration);
//            createCache(cm, "findAllNotification", jcacheConfiguration);
//
//            createCache(cm, "findAllHistoryByCurrentMonthAndUserLogin", jcacheConfiguration);
//            createCache(cm, "totalHistoryByCurrentMonthAndUserLogin", jcacheConfiguration);
//            createCache(cm, "totalHistoryByDateAndLogin", jcacheConfiguration);
//            createCache(cm, "findAllHistoryByDateAndCurrentUserLogin", jcacheConfiguration);
