...
public class CourseResource {
    ...
    public CourseResource(CourseService courseService, CourseRepository courseRepository, KafkaSendNotification kafkaSendNotification) {
    ...
    public ResponseEntity<Course> createCourse(@Valid @RequestBody Course course, Principal principal) throws URISyntaxException {
        ...
        kafkaSendNotification.alertCourse(result, principal);
    ...
    @GetMapping("/courses/get-one/{id}")
    public ResponseEntity<Course> getOneCoursesById(
        @PathVariable Long id

    ) {
        log.debug("REST request to getOneCoursesById {}", id);
