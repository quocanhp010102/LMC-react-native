...
public class StudentResource {
    ...
    @GetMapping("/students/examsId/{examsId}")
    public List<Student> getAllByExamsId(@PathVariable Long examsId){
        log.debug("REST request to getAllByExamsId", examsId);
        return  studentService.findAllByExamsId(examsId);
    }
}
