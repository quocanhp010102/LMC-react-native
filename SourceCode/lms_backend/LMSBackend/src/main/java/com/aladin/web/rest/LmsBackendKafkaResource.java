...
@RestController
@RequestMapping("/api/lms-backend-kafka")
public class LmsBackendKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LmsBackendKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LmsBackendKafkaResource(KafkaProperties kafkaProperties) {
